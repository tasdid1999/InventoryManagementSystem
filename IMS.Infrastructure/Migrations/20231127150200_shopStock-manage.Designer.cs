...
namespace IMS.Infrastructure.Migrations
{
    ...
    [Migration("20231127150200_shopStock-manage")]
    partial class shopStockmanage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IMS.Entity.Domain.ShopProductStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ShopProductStock", "Shop");
                });
            ...
            modelBuilder.Entity("IMS.Entity.Domain.ShopProductStock", b =>
                {
                    ...
                    b.HasOne("IMS.Entity.Domain.ShopRack", "Rack")
                        .WithMany()
                        .HasForeignKey("RackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IMS.Entity.Domain.ShopRow", "Row")
                        .WithMany()
                        .HasForeignKey("RowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("IMS.Entity.Domain.ShopStock", "ShopStock")
            ...
            modelBuilder.Entity("IMS.Entity.Domain.ShopStock", b =>
                {
                    b.HasOne("IMS.Entity.Domain.ShopBin", null)
                        .WithMany("ShopStocks")
                        .HasForeignKey("ShopBinId");
