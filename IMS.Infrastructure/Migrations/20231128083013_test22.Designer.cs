...
namespace IMS.Infrastructure.Migrations
{
    ...
    [Migration("20231128083013_test22")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecom.Entity.Domain.Requsition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IMS.Entity.Domain.Purchase", b =>
                {
                    ...
                    b.ToTable("Purchase", "Shop");
                });

            modelBuilder.Entity("IMS.Entity.Domain.PurchasedProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PurchaseProduct", "Shop");
                });

            modelBuilder.Entity("IMS.Entity.Domain.RequsitionDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RequsitionDetails", "Product");
                });
            ...
            modelBuilder.Entity("IMS.Entity.Domain.ShopToShopTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ShopToShopTransfer", "Shop");
                });

            modelBuilder.Entity("IMS.Entity.Domain.ShopToShopTransferProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ShopToShopTranferId")
                        .HasColumnType("int");

                    b.Property<int>("ShopToShopTransferId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShopToShopTransferId");

                    b.ToTable("ShopToShopTransferProduct", "Shop");
                });
            ...
            modelBuilder.Entity("IMS.Entity.Domain.PurchasedProduct", b =>
                {
                    b.HasOne("IMS.Entity.Domain.ProductBrand", null)
                        .WithMany("PurchasedProducts")
                        .HasForeignKey("ProductBrandId");

                    b.HasOne("IMS.Entity.Domain.ProductCatagory", null)
                        .WithMany("PurchasedProducts")
                        .HasForeignKey("ProductCatagoryId");
                    ...
                    b.HasOne("IMS.Entity.Domain.Purchase", "Purchase")
                        .WithMany("PurchasedProducts")
            ...
            modelBuilder.Entity("IMS.Entity.Domain.RequsitionDetails", b =>
                {
                    ...
                    b.HasOne("Ecom.Entity.Domain.Requsition", "Requsition")
                        .WithMany("Requsitions")
            ...
            modelBuilder.Entity("IMS.Entity.Domain.ShopToShopTransfer", b =>
                {
                    b.HasOne("IMS.Entity.Domain.Shop", "FromShop")
                        .WithMany()
                        .HasForeignKey("FromShopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IMS.Entity.Domain.Shop", "ToShop")
                        .WithMany()
            ...
            modelBuilder.Entity("IMS.Entity.Domain.ShopToShopTransferProduct", b =>
                {
                    ...
                    b.HasOne("IMS.Entity.Domain.ShopToShopTransfer", "ShopToShopTransfer")
                        .WithMany("Products")
                        .HasForeignKey("ShopToShopTransferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Product");

                    b.Navigation("ShopToShopTransfer");
                });
